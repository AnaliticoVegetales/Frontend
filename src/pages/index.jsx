          ...
          <div className="items-center flex flex-wrap">
            <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
              <img
                ...
                src={Vegetales} alt="proyectos" width="620"
              />
            </div>
            <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div className="md:pr-12">
                ...
                <h3 className="text-3xl font-semibold">Trabajo En Equipo</h3>
                <p className="mt-4 text-lg leading-relaxed text-gray-600">
                  Si deseas participar en nuestro portal, lo puedes hacer de una manera muy fácil sólo siguiendo los siguientes pasos:
                </p>
                <ul className="list-none mt-6">
                  ...
                  <li className="py-2">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-gray-600">Sube tus productos</h4>
                      </div>
                    </div>
                  </li>
                  <li className="py-2">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-gray-600">Solicita apoyo mediante asesorías, si la necesitas.</h4>
                      </div>
                    </div>
                  </li>
                  <li className="py-2">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-gray-600">Recibe retroalimentación.</h4>
                      </div>
                    </div>
                  </li>
                </ul>
      ...
      <section id="contacto" className="pb-20 relative block bg-gray-900">
        ...
        <div className="container mx-auto px-4 lg:pt-24 lg:pb-64">
          <div className="flex flex-wrap text-center justify-center">
            <div className="w-full lg:w-6/12 px-4">
              <h2 className="text-4xl font-semibold text-white">Estamos Para Ayudarte</h2>
